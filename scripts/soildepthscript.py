...
#  Execution Block
# =====================================================================
# Bypass this block when imported as a module by the main pipeline.
# Execute only when run as a standalone script in the QGIS console.
if __name__ != 'soildepthscript':
    print("--- Starting Soil Depth Generation (Standalone Mode) ---")
