# -*- coding: utf-8 -*-
# =====================================================================
# createstreamnetwork.py
# =====================================================================
# PURPOSE:
#   Master execution pipeline for generating DHSVM spatial inputs.
#   Builds hydrologically routed stream networks using QGIS and GRASS.
#   Orchestrates sub-modules (soildepth, channelclass, basemaps) to 
#   produce model-ready binary grids and topological stream datasets.
#
# ARCHITECTURE & ROUTING:
#   Enforces strict separation of intermediate artifacts and production 
#   inputs to maintain a clean workspace:
#     -> /DHSVM_input_binaries : Flat binaries (DEM, Mask, Soil, Veg, Depth)
#     -> /DHSVM_input_streams  : Topological inputs (Map, Network, Class)
#     -> /Intermediate_GIS     : Diagnostic rasters and vectors
#
# DEPENDENCIES:
...
for d in [DIR_BINARIES, DIR_STREAMS, DIR_INTERMED]:
